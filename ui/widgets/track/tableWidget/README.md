...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/track/tableWidget/>):
   1. Run `npm i`
...
- **track.table.error** (fired when an error occurs)
- **track.table.select** (fired when a table row is selected)
