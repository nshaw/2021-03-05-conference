...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/track/formWidget/>):
   1. Run `npm i`
...
- **track.form.createError** (fired when an error occurs during track creation)
- **track.form.create** (fired when the track is successfully created)
- **track.form.updateError** (fired when an error occurs during track update)
- **track.form.update** (fired when the track is successfully updated)
