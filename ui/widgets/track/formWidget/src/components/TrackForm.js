...
import { formValues, formTouched, formErrors } from 'components/__types__/track';
...
class TrackForm extends PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit} className={classes.root} data-testid="track-form">
...
const formikBag = {
  mapPropsToValues: ({ track }) => track || emptyTrack,
