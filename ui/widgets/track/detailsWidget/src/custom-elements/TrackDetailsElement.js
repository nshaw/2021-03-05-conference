...
class TrackDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'track.details.';
    ...
    const ReactComponent = React.createElement(TrackDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('track-details', TrackDetailsElement);
